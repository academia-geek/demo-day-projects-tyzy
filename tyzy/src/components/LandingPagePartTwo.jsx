  ...
  return (
    <div className='py-5' >
        <section>
            ...
            <p className='px-20 text-center md:px-72'>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation, ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in</p>
        </section>
        <section className='py-5 px-10 grid gap-3 grid-cols-[300px_1fr_1fr_1fr]'>
