...
const LandingPageFooter = () => {
  return (
    <div id='footer' className='LandingPageFooter d-flex justify-content-between'>
      ...
      <div className='d-flex my-auto text-white fs-6'><p className='my-auto'>Challenge &copy;. Coded by </p><NavLink to='#' className='link my-auto text-white'>Tyzy</NavLink></div>
