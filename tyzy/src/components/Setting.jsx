                ...
                <Offcanvas.Header >
                    <Offcanvas.Title className='d-flex mt-4 ms-4 w-100'>
                        <div className='d-flex my-auto'>
                            ...
                            <h2 className='ms-2 fs-4 text-white my-auto'>{usuario?.displayName}</h2>
                        </div>
                ...
                <Offcanvas.Body>
                    <Nav className="mx-auto d-flex flex-column ">
                        <div className='d-flex ms-3 me-5'>
                            <NavLink className='nav-link text-white' to="/perfil"><h4 className=''>Perfil</h4></NavLink>
                            <Link className='my-auto ms-auto' to='/perfil'><RiUserFill color='#B2D9D1' /></Link>
                        </div>
                        <div className='d-flex ms-3 me-5'>
                            <NavLink className='nav-link text-white' to="#Detail"><h4 className=''>Notificaciones</h4></NavLink>
                            <Link className='my-auto ms-auto' to='#'><IoMdNotifications color='#B2D9D1' /></Link>
                        </div>
                        <div className='d-flex ms-3 me-5'>
                            <NavLink className='nav-link text-white' to="#fr3"><h4 className=''>Preguntas PQR</h4></NavLink>
                            <Link className='my-auto ms-auto' to='#'><BsQuestionLg color='#B2D9D1' /></Link>
                        </div>
                        <div className='d-flex ms-3 me-5'>
                            <NavLink className='nav-link text-white' to="#Footer"><h4 className=''>Configuración</h4></NavLink>
