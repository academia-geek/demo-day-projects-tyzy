        ...
        <div className='d-flex LandingPageSup'>
            <section className='d-flex me-2 w-50'>
                <div className='ms-auto my-auto' style={{ width: '85%' }}>
                    <h2 className='H2LandingPageSup mb-3' style={{ 'fontWeight': '600' }}>Ayudamos a las personas a encontrar<span className='SPLandingPageSup' style={{ 'fontWeight': '600' }}> un animal de servicio o terapia</span></h2>
